...
![sign up page](src/assets/screenshots/signup-blank.png)
![sign up verification page](src/assets/screenshots/signup-verification.png)
![sign up survey page](src/assets/screenshots/signup-survey.png)
...
![community page](src/assets/screenshots/community.png)

### Notice Board Page

![notice page](src/assets/screenshots/notice.png)

### Calendar Page

![calendar page](src/assets/screenshots/calendar.png)

### Buddy Matching Page

![buddy matching page](src/assets/screenshots/buddy.png)

### Chat Page

![chat page](src/assets/screenshots/chat.png)
...
- Backend server running (Django backend from [separate repository](https://github.com/eunji514/Capstone-backend.git))
...
**Note**: Backend-related details regarding the endpoints are implemented in a separate Django [repository](https://github.com/eunji514/Capstone-backend.git).
...
- Backend developed by team members ([separate repository](https://github.com/eunji514/Capstone-backend.git)).
- Special thanks to course instructors and team members who contributed to the backend implementation.

---

**Note**: As mentioned previously, this repository only contains the **frontend** implementation. The backend (Python + Django) is maintained in a [separate repository](https://github.com/eunji514/Capstone-backend.git) and is required for full functionality.
